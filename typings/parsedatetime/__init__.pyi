...
class Calendar:
    ...
    """
    def __init__(self, constants=..., version=...) -> None:
        """
    ...
    def parseDate(self, dateString, sourceTime=...):
        """
    ...
    def parseDateText(self, dateString, sourceTime=...):
        """
    ...
    def evalRanges(self, datetimeString, sourceTime=...):
        """
    ...
    def parseDT(self, datetimeString, sourceTime=..., tzinfo=..., version=...): # -> tuple[Any | Unknown, Unknown]:
        """
    ...
    def parse(self, datetimeString, sourceTime=..., version=...):
        """
    ...
    def inc(self, source, month=..., year=...):
        """
    ...
    def nlp(self, inputString, sourceTime=..., version=...):
...
class Constants:
    ...
    """
    def __init__(self, localeID=..., usePyICU=..., fallbackLocales=...) -> None:
        ...
    
    def __getattr__(self, name): # -> Pattern[str] | Any:
        ...
    
    def daysInMonth(self, month, year): # -> int | None:
        """
    ...
    def getSource(self, sourceKey, sourceTime=...): # -> tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, int | Unknown, int | Unknown, int | Unknown] | None:
        """
